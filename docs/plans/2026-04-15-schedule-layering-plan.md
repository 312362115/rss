...
- [ ] 1. sources.yaml 加 schedule 字段 + GitHub Trending 配置
...
- [ ] 4. X 跨 slot 去重(.cache/x_seen.json)
...
- [ ] 6. render.py: DAILY marker + render_daily_section + render_x_slice_file
...
- [ ] 8. main.py: 调度逻辑改造(hourly + daily 自愈)
